...
//   返回最强层级 + 命中值 + parentLevel（命中层级下一级，供 folder 子匹配用）
  ...
  var CHANGES = [
    ...
    { v: "v1.22", d: "2026-08-31", items: [
      "与水利 v3.46 同步回归修复：①筛选菜单 管理所/管理站/建筑物类型 添加生效修复（filterState 持久化）；②导入压缩包照片 level-aware 三级匹配（longest-match）；③AI 结果单击/双击复制关键词 + 进一步操作提示；④隐藏当前密钥显示 + 复制密钥需密码 3305；⑤导出建筑物表格/导出照片 script error 回归验证通过。"
    ]},
...
var upGithubCfg = { public: "g101400/ganzhi-yitu-5090pub", internal: "g101400/ganzhi-yitu5090" }
var upPwaCfg = { public: "https://g101400.github.io/ganzhi-yitu-5090pub/", internal: "https://g101400.github.io/ganzhi-yitu5090/" };;
function ghChannel() {
